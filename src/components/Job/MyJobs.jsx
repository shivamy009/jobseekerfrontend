...
//   const { isAuthorized, user } = useContext(Context);
  ...
  const fetchJobs = async () => {
    try {
      const { data } = await axios.get(
          import.meta.env.VITE_SERVER_DOMAIN+'/getmyjobs',
          {
            headers:{
  ...
  const handleUpdateJob = async (jobId) => {
    ...
    await axios
      .put(import.meta.env.VITE_SERVER_DOMAIN+`/update/${jobId}`,updatedJob,
        {
          headers:{
            'authorization': `${access_token}`
          }
  ...
  const handleDeleteJob = async (jobId) => {
    await axios
      .delete(import.meta.env.VITE_SERVER_DOMAIN+`/deletejob/${jobId}`, {
        headers:{
          'authorization': `${access_token}`
        }
      }, {
